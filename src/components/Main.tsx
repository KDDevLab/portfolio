...
function Main() {
  return (
    <div className="w-full">
            ...
            <Box>
              ...
              >
                <Box>
                  ...
                  >
                    <span style={{ color: "#60a5fa", fontWeight: 400 }}>
                      Kürsat Darcan
                    </span>
                  </Typography>
                  <Typography
      ...
      <section
        id="education"
        className="min-h-screen flex items-center justify-center bg-slate-900 py-20 px-4"
      >
      ...
      <section
        id="projects"
        className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-950 to-blue-950 py-20 px-4"
      >
        <Container maxWidth="xl">
          <Fade in timeout={1000}>
            <Box>
